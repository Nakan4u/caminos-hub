...
export const officialRoutes: SeedRoute[] = [
  ...
  },
  {
    ...
    stages: [
      ...
      { fromPlace: 'Miraz', toPlace: 'Sobrado dos Monxes', distanceKm: 25.0, ascentM: 520, translations: { uk: { fromPlace: 'Мірас', toPlace: 'Собрадо-дос-Моншес' } } },
      { fromPlace: 'Sobrado dos Monxes', toPlace: 'Arzúa', distanceKm: 22.0, ascentM: 340, notes: 'Joins the French Way at Arzúa.', translations: { uk: { fromPlace: 'Собрадо-дос-Моншес', toPlace: 'Арсуа', notes: 'Приєднується до Французького шляху в Арсуа.' } } },
