-- CreateEnum
CREATE TYPE "RouteListStatus" AS ENUM ('PLANNED', 'COMPLETED');
...
CREATE TABLE "UserRoute" (
    ...
    "status" "RouteListStatus" NOT NULL,
...
-- CreateIndex
CREATE INDEX "UserRoute_userId_status_idx" ON "UserRoute"("userId", "status");
